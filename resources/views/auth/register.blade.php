                            ...
                            <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="text-center">
                                    <div class="mb-5">
                                        ...
                                        <p>Already have an account? <a href="authentication-signin-basic.html">Sign in
                                                here</a></p>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="js-form-message form-group">
                                            <input type="text" class="form-control form-control-lg"
                                                placeholder="Williams" aria-label="Williams" required=""
                                ...
                                <div class="js-form-message form-group">
                                    ...
                                    <input type="email" class="form-control form-control-lg" name="email"
                                        id="signupSrEmail" placeholder="Markwilliams@example.com"
                                        aria-label="Markwilliams@example.com" required=""
                               ...
                               "classChangeTarget": ".js-toggle-passowrd-show-icon-2"
                                ...
                                <div class="js-form-message form-group">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label text-muted" for="termsCheckbox"> I accept
