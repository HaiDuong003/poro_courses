...
@section('content')
    <form action="{{ route('edit-instructor', ['id' => request()->route('id')]) }}" method="POST"
        ...
        <div id="addUserStepProfile" class="card card-lg active">
            ...
            <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <label class="avatar avatar-xl avatar-circle avatar-uploader mr-5" for="avatarUploader">
                                <img id="avatarImg" class="avatar-img"
                                    src="{{ $instructorEdit->avatar ? Storage::url($instructorEdit->avatar) : '' }}"
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                        <input value="{{ $instructorEdit->email }}" type="email" class="form-control" name="email"
                            id="emailLabel" placeholder="Email...">
                    </div>
                </div>
                <!-- End Form Group -->
                <!-- Form Group -->
                <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                        <input value="{{ $instructorEdit->password }}" type="password" class="form-control" name="password"
                            id="emailLabel" placeholder="Password">
                    </div>
                </div>
                <!-- End Form Group -->
                <!-- Form Group -->
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" name="bio" id="" cols="30" rows="10">{{ $instructorEdit->name }}</textarea>
                    </div>
                </div>
                <!-- End Form Group -->
            </div>
