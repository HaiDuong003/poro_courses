...
@section('content')
    ...
    <div class="page-header">
        <div class="row align-items-end">
            ...
            {{-- end search --}}
            <div class="col-sm-auto">
                <a class="btn btn-primary" href="/add_user">
    ...
    <table id="datatable"
        ...
        <thead class="thead-light">
            ...
            <th class="sorting" rowspan="1" colspan="1" style="width: 101.175px;">Status</th>
            <th class="sorting" rowspan="1" colspan="1" style="width: 137.65px;">Total money
            </th>
            <th class="sorting" rowspan="1" colspan="1" style="width: 74.787px;">Role</th>
        ...
        <tbody>
            @foreach ($listStudent as $key => $student)
                <tr role="row" class="odd">
                    ...
                    <td>
                        <span class="d-block font-size-sm">{{ $student->email }}</span>
                    </td>
                    <td><img height="75px" width="75px"
                            src="{{ $student->avatar ? Storage::url($student->avatar) : '' }}" alt=""></td>
                    <td>
                        <span class="legend-indicator bg-success"></span>Active
                    </td>
                    <td>
                        <div class="d-flex align-items-center">
                            <span class="font-size-sm mr-2">{{ $student->total_money }}VNĐ</span>
                        </div>
                    </td>
                    <td>{{ $student->role == 1 ? 'Student' : 'Admin' }}</td>
                    <td>
                        <div>
                            <a class="btn btn-sm btn-white" href="edit_user/{{ $student->id }}">
                    ...
                    <td>
                        <div>
                            <a class="btn btn-sm btn-warning" href="delete/user/{{ $student->id }}">
